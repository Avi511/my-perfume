        ...
        <div className="flex flex-col items-center justify-between gap-8 p-8 lg:p-12 lg:flex-row">
          ...
          <div className="w-full text-center lg:w-1/2 lg:text-left">
            ...
            <div 
              ...
              data-aos-delay="500"
            >
              <button className="px-8 py-4 font-semibold text-white transition duration-300 transform bg-gray-900 rounded-lg hover:bg-gray-800 hover:scale-105">
                Shop Collection
              </button>
              <button className="px-8 py-4 font-semibold text-gray-700 transition duration-300 transform border-2 border-gray-300 rounded-lg hover:border-gray-400 hover:bg-gray-50 hover:scale-105">
                Learn More
              </button>
            </div>
